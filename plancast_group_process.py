...
from file_process import user_event_to_id,group_event_to_id,groupid_users_to_id
...
groupid_userids_file = "F:\\datasets\\Event-based Social Networks\\Plancast_network\\formal\\groupid_userids.dat"
